//1.2更新内容：本版本仅测试版，更新了功放状态显示程序，但在测试中并无卵用，故本版本作废
...
void loop() {
  ...
  bool QRO = digitalRead(5);

  //以下是显示电压的程序
  volt = analogRead(A0);//从A0引脚读取电压
  volta = map(volt, 0, 1023, 0, 500);
